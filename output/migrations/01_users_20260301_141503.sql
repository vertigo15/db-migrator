...
-- USERS MIGRATION SQL
-- ============================================================
-- Generated: 2026-03-01T14:15:04.578747
...
BEGIN
    ...
    RAISE NOTICE 'Generated: 2026-03-01T14:15:04.578747';
    RAISE NOTICE '============================================================';
    RAISE NOTICE '';
...
VALUES ('users_20260301_141504', 'users', 1, '{"source": "jeen-pg-dev-weu.postgres.database.azure.com:5432/postgres (prefix: jeen_dev)"}'::jsonb)
...
WHERE batch_id = 'users_20260301_141504';
