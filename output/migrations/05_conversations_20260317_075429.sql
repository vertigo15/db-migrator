...
-- ============================================================
-- Generated: 2026-03-17T07:54:35.402475
...
BEGIN
    ...
    RAISE NOTICE 'Source rows: 342';
    RAISE NOTICE 'Namespace UUID: 0b1e4c6a-1f4a-4b6e-8c3d-2a5f7e9d0c1b';
    RAISE NOTICE 'Generated: 2026-03-17T07:54:35.402514';
    RAISE NOTICE '============================================================';
...
SELECT * FROM (
  VALUES
    ...
    ('48b90c97-e29a-4abc-b7ed-0421c2eaef3a'::uuid, 'Medical Summary and Follow-up Recommendations', 2, 371, true, NULL::timestamp, '2026-01-18T14:43:20.711545'::timestamptz, '2026-01-18T14:43:20.711545'::timestamptz, '2026-01-18T14:43:20.711545'::timestamptz, uuid_generate_v5('a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d'::uuid, '306916b02924f0142a236cc978b0d013'))
