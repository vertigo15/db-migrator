...
BEGIN
    ...
    RAISE NOTICE '============================================================';
    RAISE NOTICE 'This script will migrate 37 documents to: user_db.public.documents';
    RAISE NOTICE 'Namespace UUID: 0b1e4c6a-1f4a-4b6e-8c3d-2a5f7e9d0c1b';
    RAISE NOTICE 'Generated: 2026-02-17T12:58:10.108064';
    RAISE NOTICE '============================================================';
