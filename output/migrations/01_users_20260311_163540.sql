...
-- USERS MIGRATION SQL
-- ============================================================
-- Generated: 2026-03-11T16:35:41.683705
...
BEGIN
    ...
    RAISE NOTICE 'Generated: 2026-03-11T16:35:41.683705';
    RAISE NOTICE '============================================================';
    RAISE NOTICE '';
...
VALUES ('users_20260311_163541', 'users', 1, '{"source": "jeen-pg-dev-weu.postgres.database.azure.com:5432/postgres (prefix: jeen_dev)"}'::jsonb)
...
WHERE batch_id = 'users_20260311_163541';
