...
-- USERS MIGRATION SQL
-- ============================================================
-- Generated: 2026-02-18T16:02:08.892762
...
BEGIN
    ...
    RAISE NOTICE 'Generated: 2026-02-18T16:02:08.892762';
    RAISE NOTICE '============================================================';
    RAISE NOTICE '';
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE email = 'alin@jeen.ai' OR metadata->'legacyData'->>'id' = 'ab7d0370aa10773f1c1db8e3b500374c'
    ) THEN
        INSERT INTO user_db.public.users (
            ...
            'alin',
            NULL,
            '{"legacyData": {"id": "ab7d0370aa10773f1c1db8e3b500374c", "job": null, "model": ["gemini-2.5-pro-preview-06-05", "gpt-oss-120b", "gpt-5", "gpt-5-mini", "gpt-5-nano", "gpt-5.1", "gpt-4o"], "group_id": "1", "azure_oid": null, "department": null, "token_used": "2595175", "words_used": "1133007", "subfeatures": {"reasoning": false, "web_search": true, "control_panel": true, "reasoning_web": true, "see_all_agents": false, "create_new_agent": true, "read_aloud_message": false, "organizational_files": false}, "token_limit": "500000", "company_name": null, "phone_number": null, "last_connected": "1770114750738", "letter_checkbox": null, "times_connected": "55", "enabled_features": ["admin", "voice", "sources", "automation", "chat", "workflow", "interactive"], "history_categories": null, "company_name_in_hebrew": null}}'::jsonb,
            '2025-04-24T14:11:36.482214',
            now(),
            NULL,
            gen_random_uuid(),
            NULL,
